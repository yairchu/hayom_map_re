"""
Django settings for hayom_map_re project.
...
# Log to console so things appear in "heroku logs"
LOGGING = {
    'version': 1,
...
ROOT_URLCONF = 'hayom_map_re.urls'

WSGI_APPLICATION = 'hayom_map_re.wsgi.application'
