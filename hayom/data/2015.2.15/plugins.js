...
function calculateLikud() {
    ...
    likud += answers.V1 * 8.7491656098977;
    likud += 0;
...
function calculateIsraelbeitenu() {
    ...
    israelbeitenu += answers.V1 * 2.12045792784757;
    israelbeitenu += 0;
...
function calculateYeshatid() {
    ...
    yeshatid += answers.V1 * -0.278361449286752;
    yeshatid += 0;
...
function calculateAvoda() {
    ...
    avoda += answers.V1 * -7.00042553451896;
    avoda += 0;
...
function calculateShas() {
    ...
    shas += answers.V16 * 7;
    shas += answers.V1 * -2.00042553451896;
    shas += 0;
...
function calculateYahaduthatora() {
    ...
    yahaduthatora += answers.V1 * -2.15050240013475;
    yahaduthatora += 0;
...
function calculateHabait() {
    ...
    habait += answers.V1 * 5.0004762361379;
    habait += 0;
...
function calculateKulanu() {
    ...
    kulanu += answers.V1 * -3.61378811484936;
    kulanu += 0;
...
function calculateMeretz() {
    ...
    meretz += answers.V1 * -7.00042553451896;
    meretz += 0;
...
function calculateAravim() {
    ...
    aravim += answers.V1 * -7.00042553451896;
    aravim += -0.01;
...
function calculateHaamitanu() {
    ...
    haamitanu += answers.V1 * 0.38234104443201;
    haamitanu += 0;
